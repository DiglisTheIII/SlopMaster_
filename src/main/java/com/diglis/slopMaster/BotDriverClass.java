...
public class BotDriverClass {
    ...
    public static void main(String[] args) throws LoginException, IOException {
        ...
        JDA jda = JDABuilder.createDefault(token, GatewayIntent.GUILD_MESSAGES, GatewayIntent.GUILD_MEMBERS, GatewayIntent.GUILD_PRESENCES, GatewayIntent.GUILD_VOICE_STATES, GatewayIntent.GUILD_WEBHOOKS)
                ...
                .addEventListeners(new Commands(), new ModCommands(), new PrivateMessages(), new JoinEventHandler(), new LeaveEventHandler())
